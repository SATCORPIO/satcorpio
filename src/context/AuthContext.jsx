...
const ALL_MODULES = ['450kpar', 'dualcore-900', 'gendashv2', 'xoi-audit', 'xoi-client']

// Registered users — credentials stored here for now
const USERS = [
  { username: 'anu@satcorp.io',     password: 'Hess1862$',       role: 'admin',    modules: ALL_MODULES },
  { username: 'iss@satcorp.io',     password: 'Muscleman320$',   role: 'operator', modules: ['450kpar', 'dualcore-900', 'gendashv2'] },
