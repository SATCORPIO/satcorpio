...
export default function Kyrax() {
  ...
  const handleSubmit = async (e) => {
    ...
    const embed = {
      ...
      footer: { text: 'SATCORP Service Request System — satcorp.io / KYRAX' },
  ...
  return (
    <div className="page-wrapper portal-page pulse-operator-wrapper" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .modal-btn.primary {
          background: #3b82f6; color: #fff; border: none; font-weight: bold;
        }
        .modal-btn.primary:hover { background: #60a5fa; box-shadow: 0 0 15px #3b82f6; }
        .modal-btn.secondary {
        ...
        .deck-list li::before { content: '▹'; position: absolute; left: 0; color: #3b82f6; }
        ...
        .pulse-input:focus, .pulse-textarea:focus, .pulse-select:focus { outline: none; border-color: #3b82f6; }
        
        .pulse-checkbox-group { display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px; }
        .pulse-checkbox { mt-1 flex-shrink-0; width: 18px; height: 18px; accent-color: #3b82f6; }
          ...
          <div className="skill-deck-content" onClick={e => e.stopPropagation()}>
            <div className="skill-deck-header">
              <div>
                ...
                <div style={{ color: '#3b82f6', fontSize: '0.85rem', marginTop: '4px' }}>// MODULE: {activeCard.title.toUpperCase()}</div>
              </div>
            ...
            <div className="skill-deck-body">
              {submitSuccess ? (
                <div style={{ textAlign: 'center', padding: '40px 0', color: '#3b82f6' }}>
                  ...
                  <p style={{ color: '#aaa' }}>KYRAX AI entities have been notified.</p>
                </div>
              ) : (
